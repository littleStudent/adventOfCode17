...
isValidPartA : String -> Bool
isValidPartA password =
    let
        words = String.split " " password
    in
        List.length words == List.length (List.Extra.unique words)


isValidPartB : String -> Bool
isValidPartB password =
    let
        words = String.split " " password
            |> List.map (String.split "" >> List.sort)
    in
        List.length words == List.length (List.Extra.unique words)
